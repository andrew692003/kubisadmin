 ...
 */
public class ListAdapterSubmission extends FirebaseListAdapter {
    Activity activity;
    Context context;
    /**
     ...
     */
    public ListAdapterSubmission(Query mRef, int mLayout, Activity activity, Context context) {
        super(mRef, mLayout, activity);
